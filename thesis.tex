...
Other systems such as IBM's ClearCase\footnote{
  http://www-01.ibm.com/software/awdtools/clearcase } and Microsoft's
Visual SourceSafe and Team Foundation Server\footnote{
  http://www.microsoft.com } existed, but being proprietary tools they
never grew popular in the open source community, and their popularity
in big corporations is hard to measure.
